   ...
   // static String elasticUrl = "http://10.128.15.219:9200";
    ...
    public   static void runPasPipeline(pasPipelineOptions options)
    {
       ...
       /**
        ...
        PCollection<KV <String, Parcel> > opParcelwiId = groupedCollection.apply("Add additional Filters to get the joined records .. ",
                    ...
                    public void processElement(@Element  KV<String,CoGbkResult> input, OutputReceiver<KV<String, Parcel>> out)
                    {
                        ...
                        for (PasPrcl parcel:PasPrclrecs)
                        {
                            ...
                            if(parcel.getSOR_CD().equals("TXA"))
                            {
                                ...
                                log.info("The output object is::"+opParcel.toString());
         ...
         */
        PCollection<Parcel> opParcels = opParcelwiId.apply(ParDo.of(new DoFn<KV<String, Parcel>, Parcel>() {
            @ProcessElement
       ...
       PCollection<String> jsonString = opParcels.apply("ConvertoJson", AsJsons.of(Parcel.class));
        ...
        PCollection<OutputByInstallment> opByInstallment = opParcelwiId.apply(ParDo.of(new DoFn<KV<String, Parcel>, OutputByInstallment>() {
